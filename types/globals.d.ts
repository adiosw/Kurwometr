// Extend Window with browser APIs not in standard TypeScript lib
interface Window {
  ...
  gtag?: (...args: any[]) => void;
  dataLayer?: any[];
  trackKurwa?: (source: string) => void;
  trackDonate?: (amount: number) => void;
  trackLuckyShot?: (tier: number) => void;
}
